...
export const msalConfig = {
    auth: {
        clientId: '4e63d817-c659-4676-8a6d-d0886466d6db', // This is the ONLY mandatory field that you need to supply.
...
export const loginRequest = {
    scopes: [...protectedResources.lenderAPI.scopes.lender],
};