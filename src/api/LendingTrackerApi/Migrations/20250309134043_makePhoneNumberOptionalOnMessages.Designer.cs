...
namespace LendingTrackerApi.Migrations
{
    ...
    [Migration("20250309134043_makePhoneNumberOptionalOnMessages")]
    partial class makePhoneNumberOptionalOnMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LendingTrackerApi.Models.Borrower", b =>
                {
                    ...
                    b.HasIndex("BorrowerId", "UserId")
                        .IsUnique();

                    b.HasIndex(new[] { "UserId" }, "IX_Borrowers_UserId");

                    b.HasIndex(new[] { "BorrowerEmail", "UserId" }, "UQ__Borrower__User__14F16AF6B87CB05D")
                        .IsUnique();
            ...
            modelBuilder.Entity("LendingTrackerApi.Models.Item", b =>
                {
                    ...
                    b.HasIndex(new[] { "OwnerId" }, "IX_Items_OwnerId");
            ...
            modelBuilder.Entity("LendingTrackerApi.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("LendingTrackerApi.Models.Item", "Item")
                        .WithOne("Transaction")
                        .HasForeignKey("LendingTrackerApi.Models.Transaction", "ItemId")
                        .IsRequired()
